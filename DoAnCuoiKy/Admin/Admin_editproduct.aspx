...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
        ...
        <table>
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Text="Tên sản phẩm là bắt buộc" ControlToValidate="AddProductName" SetFocusOnError="true" Display="Dynamic"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>
        ...
        <asp:Button ID="EditProductButton" runat="server" Text="Sửa sản phẩm" OnClick="EditProductButton_Click" CausesValidation="true" />
