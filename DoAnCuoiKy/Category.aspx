<%@ Page Language="C#" MasterPageFile="~/eWorld.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="DoAnCuoiKy.Category1" %>

<%@ Import Namespace="System.Globalization" %>

<asp:Content ID="Categories" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <div class="Content pdr col-md-12">
            <div class="Content col-md-10 clearfix">
                <div class="breadcrumb">
                    ...
                    <asp:HyperLink ID="Link_cate" runat="server"></asp:HyperLink>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12 text-center pager">
                    <asp:DataPager ID="ProductListPagerCombo" runat="server"
                        PagedControlID="Category" PageSize="8">
                        <Fields>
